    ...
    <form @submit=${onSubmit}>
        <fieldset class="grid">
            ...
            <fieldset class="field">
                ...
                <input name="vin" type="text" placeholder="3N1BC13E99L480541" .value=${repair.vin}>
            ...
            <fieldset class="field">
                ...
                <input name="model" type="text" placeholder="Insignia" .value=${repair.model}>
    
                <label for="engine">Двигател:</label>
                <input name="engine" type="text" placeholder="2.0" .value=${repair.engine}>
            </fieldset>
            ...
            <input class="submit btn btn-default" type="submit" value="Редактирай">
